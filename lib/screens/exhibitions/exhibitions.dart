...
import 'package:concetto_app/screens/exhibitions/exhibition_details.dart';
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: Scaffold(
            ...
            body: FutureBuilder(
                future: ExhibitionRepository().getExhibitions(),
                builder:
                    (context, AsyncSnapshot<List<ExhibitionModel>?> snapshot) {
...
class ExhibitionListBox extends StatelessWidget {
  final ExhibitionModel exhibitionModel;
  const ExhibitionListBox({required this.exhibitionModel, super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) =>
                  ExhibitionDetails(exhibitionModel: exhibitionModel)));
        },
